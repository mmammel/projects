...
MSL Target Site GC (Gale Crater) Topocentric Frame Definition Kernel
===============================================================================

     Created by Boris Semenov, NAIF/JPL, Tue Nov 30 09:32:48 PST 2010
...
-------------------------------------------------------------------------------
     ...
     definition is built are:
        ...
        Lon = 137.420000 degrees East
        Lat =  -4.543182 degrees North
	 ...
	 TKFRAME_-76900_ANGLES       = ( -137.42, -94.543182, 180.000  )
