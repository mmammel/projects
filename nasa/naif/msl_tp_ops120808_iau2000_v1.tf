...
MSL Target Site GC (actual, 2012-08-08 solution) Topocentric Frame Definition Kernel
===============================================================================

     Created by Boris Semenov, NAIF/JPL, Wed Aug  8 16:34:14 PDT 2012
...
--------------------------------------------------------
     ...
     landing site GC (actual, 2012-08-08 solution):
