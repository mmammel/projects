...
MSL Target Site GC (Gale Crater, final target) Topocentric Frame Definition Kernel
===============================================================================

     Created by Boris Semenov, NAIF/JPL, Thu Jun  7 10:25:10 PDT 2012
...
--------------------------------------------------------
     ...
     landing site GC (Gale Crater, final target):
...
-------------------------------------------------------------------------------
     ...
     definition is built are:
        ...
        Lon = 137.445000 degrees East
        Lat =  -4.612993 degrees North
	 ...
	 TKFRAME_-76900_ANGLES       = ( -137.445, -94.612993, 180.000  )
