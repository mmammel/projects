 ...
 *     new Point3d(2.0, 0.0, 0.0), new Point3d(0.5, 0.5, 0.5), new Point3d(0.0, 0.0, 2.0), new Point3d(0.1, 0.2, 0.3),
...
public class QuickHull3D {
   ...
   *           the number of input points is less than four, or the points appear
   ...
   *
   * @param coords
   *          returns the x, y, z coordinates of each vertex. This length of this
   *          array must be at least three times the number of vertices.
