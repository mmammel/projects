...
public class SshDssPublicKey extends SshPublicKey {
    ...
    public boolean verifySignature(byte[] signature, byte[] data)
        ...
        try {
             ...
             */
      log.debug( "Verifiying Signature..." );
            Signature sig = Signature.getInstance("SHA1withDSA");
      log.debug( "Signature info: " + sig );
      log.debug( "Initializing Signature Verify..." );
            sig.initVerify(pubkey);
      log.debug( "Updating with data: " + new String(data) );
            sig.update(data);
      log.debug( "Doing actual verificiation..." );
      boolean retVal = sig.verify(encoded);
      log.debug( "Did Verification of [" + sig + "], got: " + retVal );
      return retVal;
