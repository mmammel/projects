...
public class LeakerTask3 extends TimerTask
{
  ...
  */
  ...
  {
    LeakerTask3 LT = null;
    int limit = LeakerTask3.DEFAULT_RUNS;
    long interval = LeakerTask3.DEFAULT_INTERVAL;
    ...
    for( int i = 0; i < args.length; i++ )
    {
      if( args[i].startsWith( "-i" ) )
      {
        ...
        catch( NumberFormatException nfe )
        {
          ...
          interval = LeakerTask3.DEFAULT_INTERVAL;
        }
      }
      else if( args[i].startsWith( "-n" ) )
      {
        ...
        catch( NumberFormatException nfe )
        {
          ...
          limit = LeakerTask3.DEFAULT_RUNS;
        }
      }
