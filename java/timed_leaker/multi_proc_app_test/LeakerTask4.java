...
public class LeakerTask4 extends TimerTask
{
  ...
  */
  ...
  {
    LeakerTask4 LT = null;
    int limit = LeakerTask4.DEFAULT_RUNS;
    long interval = LeakerTask4.DEFAULT_INTERVAL;
    ...
    for( int i = 0; i < args.length; i++ )
    {
      if( args[i].startsWith( "-i" ) )
      {
        ...
        catch( NumberFormatException nfe )
        {
          ...
          interval = LeakerTask4.DEFAULT_INTERVAL;
        }
      }
      else if( args[i].startsWith( "-n" ) )
      {
        ...
        catch( NumberFormatException nfe )
        {
          ...
          limit = LeakerTask4.DEFAULT_RUNS;
        }
      }
