...
public class LeakerTask1 extends TimerTask
{
  ...
  */
  ...
  {
    LeakerTask1 LT = null;
    int limit = LeakerTask1.DEFAULT_RUNS;
    long interval = LeakerTask1.DEFAULT_INTERVAL;
    ...
    for( int i = 0; i < args.length; i++ )
    {
      if( args[i].startsWith( "-i" ) )
      {
        ...
        catch( NumberFormatException nfe )
        {
          ...
          interval = LeakerTask1.DEFAULT_INTERVAL;
        }
      }
      else if( args[i].startsWith( "-n" ) )
      {
        ...
        catch( NumberFormatException nfe )
        {
          ...
          limit = LeakerTask1.DEFAULT_RUNS;
        }
      }
