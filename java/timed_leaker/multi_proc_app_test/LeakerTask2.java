...
public class LeakerTask2 extends TimerTask
{
  ...
  */
  ...
  {
    LeakerTask2 LT = null;
    int limit = LeakerTask2.DEFAULT_RUNS;
    long interval = LeakerTask2.DEFAULT_INTERVAL;
    ...
    for( int i = 0; i < args.length; i++ )
    {
      if( args[i].startsWith( "-i" ) )
      {
        ...
        catch( NumberFormatException nfe )
        {
          ...
          interval = LeakerTask2.DEFAULT_INTERVAL;
        }
      }
      else if( args[i].startsWith( "-n" ) )
      {
        ...
        catch( NumberFormatException nfe )
        {
          ...
          limit = LeakerTask2.DEFAULT_RUNS;
        }
      }
