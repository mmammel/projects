...
public class LeakerTask extends TimerTask
{
  ...
  */
  ...
  {
    LeakerTask LT = null;
    int limit = LeakerTask.DEFAULT_RUNS;
    long interval = LeakerTask.DEFAULT_INTERVAL;
    ...
    for( int i = 0; i < args.length; i++ )
    {
      if( args[i].startsWith( "-i" ) )
      {
        ...
        catch( NumberFormatException nfe )
        {
          ...
          interval = LeakerTask.DEFAULT_INTERVAL;
        }
      }
