...
public class TemplateUtil {
  ...
  private Pattern pattern;
    ...
    /*
     * shorthand for having to create a new instance
     */
    public static String processTemplate( String template, Map<String,String> variables ) throws IOException {
      TemplateUtil util = new TemplateUtil( template );
      return util.processTemplate(variables);
    }
